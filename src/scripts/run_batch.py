...
from src.sipit.sipit_w_rank_3 import sipit
...
def parse_args():
    ...
    parser.add_argument("--out_dir", type=str, default="results/batch")
...
def main():
    ...
    while processed < args.samples:
        try:
            ...
            token_times = result.get("per_token_times", [])
            avg_token_time_s = sum(token_times) / len(token_times) if token_times else 0.0
